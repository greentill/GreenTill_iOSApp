...
public class QRScannerView: UIView {
    ...
    private func setupImageViews() {
        ...
        let image = focusImage ?? UIImage(named: "scan_qr_focus", in: Bundle(for: QRScannerView.self), compatibleWith: nil)
        focusImageView.image = image?.withRenderingMode(.alwaysTemplate)
        focusImageView.tintColor = UIColor.init(red: 62.0/255.0, green: 184.0/255.0, blue: 62.0/255.0, alpha: 1.0)
