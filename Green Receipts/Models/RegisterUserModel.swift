...
class RegisterUserModel : NSObject, NSCoding{
	...
	init(fromDictionary dictionary: [String:Any]){
        ...
        {
            if(utilityObject.hasValue(object: gender as AnyObject))
            {
        ...
        if let middlename = dictionary["middlename"]
        {
            if(utilityObject.hasValue(object: middlename as AnyObject))
            {
